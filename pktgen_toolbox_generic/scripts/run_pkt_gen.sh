...
for vf_pci_addr in "${selected_target_vf[@]}";
...
echo "Starting pkt gen selected cores $SELECTED_CORES selected VFs $SELECTED_VF device macs: $DEVICE_MAC_ADDRESSES"
